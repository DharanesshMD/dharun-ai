import { RootLayout, ErrorBoundary } from '@repo/common/components';
...
export const metadata: Metadata = {
    title: 'Dharun AI - Go Deeper with AI-Powered Research & Agentic Workflows',
    description:
